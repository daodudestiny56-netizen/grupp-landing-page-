...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-col lg:flex-row items-center justify-between max-w-[1280px] mx-auto px-[var(--page-px)] pt-24 pb-12 lg:py-0 h-full w-full relative z-10"
      >
        {/* Text Column */}
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left lg:w-[55%]">
          ...
          <FadeSlideUp delay={0.2}>
            <p className="text-[clamp(15px,1.5vw,18px)] max-w-[320px] md:max-w-2xl leading-[1.75] mb-10 text-zinc-400 mx-auto lg:mx-0">
          ...
          <FadeSlideUp delay={0.3}>
            <div className="flex flex-col sm:flex-row gap-3 mb-12 w-full max-w-[320px] sm:max-w-none mx-auto lg:mx-0">
              <Link
                href="#"
        ...
        {/* Phone Mockup Column */}
        <div className="hidden md:flex flex-col items-center justify-center mt-12 lg:mt-0 w-[60vw] max-w-[360px] lg:w-[45%] hero-phone-mockup">
          {/* Mockup area reserved as per specifications */}
        </div>
      </div>
    </section>
  );
